...
if __name__ == "__main__":
    ...
    board_tool.httpul.httpulfile_sync(
        remoteip, 22, boardusr, boardpass, local_file, "/tmp/lowdelay_relay"
    )
    ...
    local_file = "tmp/" + "scp"
    fileopt.ftpdownload(ftpip, ftpcwd, ftpusr, ftppass, "scp", local_file)

    board_tool.httpul.httpulfile_sync(
        remoteip, 22, boardusr, boardpass, local_file, "/tmp/scp"
    )
