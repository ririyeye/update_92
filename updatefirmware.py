...
if __name__ == "__main__":
    boardusr='root'
    boardpass='artosyn'
    updatecmd("192.168.1.100","artosyn-upgrade-sirius-0.0.0.1.img",boardusr,boardpass)
    updatecmd("192.168.10.101","artosyn-upgrade-sirius-0.0.0.1.img",boardusr,boardpass)
    os.system("pause")
